...
# и сравнивает с собой — так ловится скачок между прогонами.
#
# 17.08.2026 переехали с GitHub Pages на Netlify: на Pages страница с ФИО
# и зарплатами висела открытой для всего интернета. Теперь слепок отдаётся
# функцией и только по служебному ключу BUILD_TOKEN — сравнение живёт,
# а посторонний ничего не получит.
import os

PUBLIC_URL = os.environ.get("DASH_URL", "https://rezerv-dashboard.netlify.app")
METRICS_URL = PUBLIC_URL + "/api/metrics"
